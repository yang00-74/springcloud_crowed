...
public class Constant {
	...
	public static final String NO_MESAGE = "NO_MESAGE";
	...
	public static final String MESSAGE_REDIS_TIMEOUT_INVALID ="Redis timeout invalid!";
	public static final String MESSAGE_PHONE_NUM_INVALID = "Phone number invalid!";
	public static final String MESSAGE_LOGIN_ACCT_INVALID = "Login account invalid!";
	public static final String MESSAGE_RANDOM_CODE_INVALID =  "Random code invalid!";
