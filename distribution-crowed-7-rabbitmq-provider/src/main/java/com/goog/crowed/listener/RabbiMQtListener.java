...
@Component
public class RabbiMQtListener {

    @RabbitListener(
            bindings = @QueueBinding(value = @Queue(value = "RABBITMQ.YANG.SAVE.QUEUE", durable = "true"),
    ...
    public void save(String key) {
        if (CrowdUtils.isEmpty(key)) {
            System.out.println("Rabbit listener:" + Constant.MESSAGE_RABBITMQ_MESSAGE_INVALID);
        }
        System.out.println("Rabbit listener: save success" + key);
    }
}
